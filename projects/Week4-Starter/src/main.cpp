...
int main() {
	...
	interleaved2_vbo->LoadData(interleaved2, 6 * 6);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(glm::cos(static_cast<float>(thisFrame)), 0.0f, 0));
		//transform3 = glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(1, 0, 0));

		//transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(0, 0.0f, 1.0f));
